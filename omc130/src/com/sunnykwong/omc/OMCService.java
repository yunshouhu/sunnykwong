...
public class OMCService extends Service {
	...
	public void onCreate() {
		if (OMC.DEBUG)Log.i(OMC.OMCSHORT + "Svc","Creating Svc");
    ...
    public void onStart(Intent intent, int startId) {
		if (OMC.DEBUG)Log.i(OMC.OMCSHORT + "Svc","Starting Svc (pre2)");
...
//		sendBroadcast(OMC.WIDGETREFRESHINTENT);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		if (OMC.DEBUG)Log.i(OMC.OMCSHORT + "Svc","Starting Svc (2+)");
		//	Tell the widgets to refresh themselves.
		OMCService.RUNNING=true;
