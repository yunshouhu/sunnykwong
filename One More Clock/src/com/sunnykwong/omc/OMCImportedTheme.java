...
public class OMCImportedTheme implements java.io.Serializable {
	...
	static public HashMap<String,ArrayList<String>> arrays;
	static public HashMap<String,Bitmap> bitmaps;
	static public String name;
	
	public OMCImportedTheme (String nm) {
		OMCImportedTheme.name = nm;
