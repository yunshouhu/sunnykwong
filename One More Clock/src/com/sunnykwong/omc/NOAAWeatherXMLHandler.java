...
public class NOAAWeatherXMLHandler extends DefaultHandler {
	...
	public void characters(char[] ch, int start, int length) {
		...
		if (tree.peek(1)[0].equals("temperature")) {
			System.out.println (tree.peek(1)[0] + " ### " +tree.peek(0)[0]+ " ### " + VALUETYPE + " ### " + value);
			...
			if (!tree.isEmpty()) {
				...
				if (localName.equals("weather-conditions") && atts.getValue("weather-summary")!=null) {
					...
					if (bCurrentObservations) {
						...
						System.out.println (sCondition + " - " + NOAAWeatherXMLHandler.getTranslation(sCondition) + OMC.VERBOSEWEATHER[NOAAWeatherXMLHandler.getTranslation(sCondition)]);
